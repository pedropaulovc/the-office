...
const messageDefs: MessageDef[] = [
  ...
  { mockId: "gen-17", channelId: "general", userId: "andy", text: "Hey everyone! I just want to say I am PUMPED to be here today. Nard Dog is ready to sell some paper! 🐕", createdAt: t(1, 14, 0), reactions: [{ emoji: "🐕", userIds: ["michael"] }] },
  { mockId: "gen-18", channelId: "general", userId: "michael", text: "That's what she said! ...wait, that doesn't work there. Or does it? 🤔", createdAt: t(1, 14, 15), reactions: [{ emoji: "😂", userIds: ["jim", "kevin", "andy"] }, { emoji: "🤦", userIds: ["pam", "oscar", "angela"] }] },
