...
export function makeOutOfCharacter(agentId: string): string {
...
export function makeRepetitive(baseText: string): string {
...
export function makeFormulaic(): string {
...
export function makeEnthusiasticStanley(): string {
